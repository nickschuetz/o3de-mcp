...
{"tool": "add_component", "arguments": {"entity_id": "<player_id>", "component_type": "PhysX Primitive Collider"}}
{"tool": "add_component", "arguments": {"entity_id": "<player_id>", "component_type": "PhysX Dynamic Rigid Body"}}
...
{"tool": "add_component", "arguments": {"entity_id": "<goal_id>", "component_type": "PhysX Primitive Collider"}}
...
- `Player` — ball with Mesh, PhysX Primitive Collider, PhysX Dynamic Rigid Body, Lua Script
- `GoalZone` — trigger primitive collider with Lua Script
...
Expected: `Mesh`, `PhysX Primitive Collider`, `PhysX Dynamic Rigid Body`, `Transform`.
